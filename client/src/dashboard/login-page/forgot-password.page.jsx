...
import {
  resetPasswordApplicantDispatchLink,
  resetPasswordStudentDispatchLink,
} from "../http-requests";
...
const ForgotPassword = () => {
  ...
  const handleReset = async () => {
    if (loginType === "APPLICANT") {
      await resetPasswordApplicantDispatchLink(formFields.email)
        .then((res) => {
      ...
      await resetPasswordStudentDispatchLink(formFields.email)
        .then((res) => {
          setFeedback([1, 1, res.message]);
          navigate("/");
        })
      ...
      console.log("link sent for student");
    }
  };
