...
const EditMemberModal = ({ id, onClose }) => {
  ...
  const handleNoDueSlipIssue = async () => {
  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        onYes={handleNoDueSlipIssue}
        show={alert}
        title="Are you sure of it to issue No Due Slip?"
        table={[
      ...
      >
        <div>
          <p className="text-gray-400 mt-5">
            This will mark above member and all their library cards as "CLEARED"
            and member shall not be allowed to use library services anymore.
          </p>
        </div>
      </ConfirmationModal>
    </>
