    ...
    <div className="px-2 md:px-10 py-5 flex flex-col gap-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            who processes the data on behalf of the University Library. It
            refers to third-party companies or individuals employed by the
            University Library to facilitate the Service, to provide the Service
            on behalf of the University Library, to perform services related to
            the Service or to assist the University Library in analyzing how the
            Service is used.
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          permit the University Library, for example, to count users who have
      ...
      <p>
        The University Library may use Personal Data for the following purposes:
      </p>
      <ul>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          ...
          any merger, sale of University Library assets, financing, or
      ...
      <p>
        The University Library will retain Your Personal Data only for as long
      ...
      <p>
        The University Library will also retain Usage Data for internal analysis
      ...
      <p>
        ...
        University Library's operating offices and in any other places where the
      ...
      <p>
        The University Library will take all steps reasonably necessary to
      ...
      <p>
        If the University Library is involved in a merger, acquisition or asset
      ...
      <p>
        Under certain circumstances, the University Library may be required to
      ...
      <p>
        The University Library may disclose Your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>Comply with a legal obligation</li>
        <li>
          Protect and defend the rights or property of the University Library
        </li>
        <li>
