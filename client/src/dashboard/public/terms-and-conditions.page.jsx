...
const TermsAndConditionsPage = () => {
  return (
    <div className="px-2 md:px-10 py-5 flex flex-col gap-5">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>University Library</strong> (referred to as either &quot;the
            University Library&quot;, &quot;Library&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
            Library SBSSU, SHAHEED BHAGAT SINGH STATE UNIVERSITY, MOGA ROAD
        ...
        <li>
          <p>
            ...
            entire agreement between You and the University Library regarding
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Library SBSSU, accessible from{" "}
            <a
              href="library.sbssu.ac.in"
      ...
      <p>
        ...
        the agreement that operates between You and the University Library.
      ...
      <p>
        By applying for membership, You agree to provide personal information
        including a photograph, which will be collected, stored, and used in
        accordance with Our Privacy Policy.
      </p>
      <p>
        Your access to and use of the Service is also conditioned on Your
        acceptance of and compliance with the Privacy Policy of the University
        Library. Our Privacy Policy describes Our policies and procedures on the
      ...
      <p>
        You are supposed to comply with all library rules (Contact Library for
        detailed rules).
      </p>
      <p>
        Library reserved the rights to change any rule at any time without prior
        information.
      </p>
      <p></p>
      ...
      <p>
        ...
        are not owned or controlled by the University Library.
      </p>
      <p>
        The University Library has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree
        that the University Library shall not be responsible or liable, directly
      ...
      <p>
        ...
        of the University Library and any of its suppliers under any provision
      ...
      <p>
        ...
        University Library or its suppliers be liable for any special,
        ...
        this Terms), even if the University Library or any supplier has been
      ...
      <p>
        ...
        University Library, on its own behalf and on behalf of its Affiliates
        ...
        limitation to the foregoing, the University Library provides no warranty
      ...
      <p>
        Without limiting the foregoing, neither the University Library nor any
        ...
        University Library are free of viruses, scripts, trojan horses, worms,
      ...
      <p>
        ...
        try to resolve the dispute informally by contacting the University
        Library.
      </p>
      ...
      <ul>
        <li>
          By mail: SHAHEED BHAGAT SINGH STATE UNIVERSITY, MOGA ROAD ,FIROZPUR,
          PUNJAB 152004
        </li>
      </ul>
    </div>
