              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-700 dark:text-green-300">
                    ...
                    available • {book.issuedCopies} currently issued
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 text-center">
                ...
                <div className="flex items-center justify-center space-x-2 mb-4">
                  <div className="flex space-x-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <div
                        key={star}
                        className={`w-4 h-4 ${
                          star <= Math.floor(book.ratings.average)
                            ? "text-yellow-400"
                            : "text-gray-300"
                        }`}
                      >
                  ...
                  <span className="text-sm text-gray-600 dark:text-gray-400">
                    {book.ratings.average} ({book.ratings.total} reviews)
                  </span>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700">
              <div className="p-8">
                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
                  ...
                  Current Issues ({book.issuedCopies})
                </h4>

                <div className="space-y-4">
                  {book.currentIssues.map((issue, index) => (
                    <div
                      key={index}
