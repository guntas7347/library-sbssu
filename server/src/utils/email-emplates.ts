...
export const mailTemplate = {
  otp: (name: string, otp: string): string => {
  ...
  rejectionEmail: (memberName: string): string => {
    return mailGenerator.generate({
      body: {
        name: memberName,
  ...
  noDueConfirmationEmail: (
    memberName: string,
    membershipID: string,
    clearedDate: Date | string = new Date()
  ): string => {
    return mailGenerator.generate({
      body: {
        name: memberName,
