...
const crs = {
  ...
  LOGIN403FB: (payload = null) =>
    createCustomResponseObject("LOGIN403FB", "Login forbidden", payload),
  CUSTOMRES: (res = "") => createCustomResponseObject("CUSTOMRES", res, null),
  PRISMA2002ERR: (error = "") =>
    createCustomResponseObject("PRISMA2002ERR", "Duplicate value", error),
  ...
  AUTH401FP: (payload = null) =>
    createCustomResponseObject("AUTH401FP", "New device detected.", payload),
